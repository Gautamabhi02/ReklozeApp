                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            Icon(
                              widget.isOpportunityCreated ? Icons.check_circle : Icons.error,
                              color: widget.isOpportunityCreated ? successColor : errorColor,
                              size: 60,
                            ),
                            ...
                            if (widget.processingErrors != null && widget.processingErrors!.isNotEmpty) ...[
                              const SizedBox(height: 20),
                              const Text(
                                'Errors occurred:',
